    ...
    <div className="container">
      <div className='md:flex items-center'>
        <div className='md:w-auto'>
          ...
          <h1 className="text-5xl md:text-7xl text-center font-bold tracking-tighter py-2 bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-6">Track, Analyze, and Optimize Your Brand Reputation.</h1>
          {/* Smarter decisions powered by AI */}
          <p className="text-xl text-[#010D3E] tracking-tight text-center mt-6">Our advanced social listening and AI-powered review monitoring tool across all digital channels captures customer feedback, analyzes brand mentions, and delivers actionable insights from social media and online conversations.</p>
